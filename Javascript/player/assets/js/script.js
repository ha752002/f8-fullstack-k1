...
var lyric = `{
    ...
    "data": {
      ...
      "beat": "https://mcloud-bf-s9-audio-zmp3.zmdcdn.me/F0M-Zli1wNY/f66c0b5978169148c807/76af45a38be562bb3bf4/96/accompaniment.m4a?authen=exp=1694519823~acl=/F0M-Zli1wNY/*~hmac=6faf3aa6eb413d23598ec120f6b1c9ae",
      "enabledVideoBG": true,
      "defaultIBGUrls": [
    ...
    "timestamp": 1694357965712
  }`



//dùng filter để làm phát nhạc

var lyric = JSON.parse(lyric).data.sentences;
var lyric = lyric.filter(function (item) {
  return item.type == 1;
});

var lyric = lyric.map(function (item) {
  return item.text;
});
