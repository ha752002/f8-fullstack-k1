...
function CartButton(props) {
    ...
    const amountCart = () => cartProducts.reduce((total, {amount}) => {
        return total + amount;
    }, 0)
    ...
    return (<>
         <NavLink to={"/cart"} >
             <div className="d-flex align-items-center"  >
                 <svg stroke="white" fill="currentColor" viewBox="0 0 16 16" id="hand-bag"
                 ...
                 <div id="number-of-products" style={{color: "white", marginLeft : "10px", fontSize : "1.3rem"}}>{amountCart()}</div>
             </div>
         </NavLink>
    </>);
}
