...
app.innerHTML = `${(0, _header.Header)()} ${(0, _home.Home)()} ${(0, _footer.Footer)()}`;

},{"./components/Header":"hsJbF","./components/Footer":"8pPOA","./pages/Home":"KEnRd"}],"hsJbF":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"KEnRd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Home = ()=>{
    const today = (0, _momentDefault.default)().format("YYYY-MM-DD");
    return `<h1>Home</h1>
    <h2>${today}</h2>
    `;
};
...
},{}]},["iWvxK","bNKaB"], "bNKaB", "parcelRequire4d5e")
